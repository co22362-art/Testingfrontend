              ...
              <PACard className="p-5 hover:shadow-md transition-all duration-200 cursor-pointer group">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-3xl font-bold text-[#111827]">{stats.currentStreak} days</p>
                  </div>
                </div>
              </PACard>
              ...
              <PACard className="p-5 hover:shadow-md transition-all duration-200 cursor-pointer group">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-3xl font-bold text-[#111827]">{stats.totalEntries}</p>
                  </div>
                </div>
              </PACard>
              ...
              <PACard className="p-5 hover:shadow-md transition-all duration-200 cursor-pointer group">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-3xl font-bold text-[#111827]">{stats.weeklyScore}</p>
                  </div>
                </div>
              </PACard>
            </div>
              ...
              <PACard className="p-6 bg-gradient-to-br from-blue-50 to-white border-[#E5E7EB]">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex-1 min-w-0">
                    <h3 className="font-semibold text-[#111827] text-lg mb-1">{profile.name}</h3>
                    <p className="text-sm text-[#6B7280] mb-2">{profile.team}</p>
                ...
                <button 
                  ...
                  className={`h-12 px-10 rounded-lg font-bold transition-all duration-200 transform ${
                    isSaving
                      ...
                      : 'bg-gradient-to-r from-[#1976D2] to-[#1565C0] text-white hover:shadow-xl hover:scale-105'
                  }`}
                >
