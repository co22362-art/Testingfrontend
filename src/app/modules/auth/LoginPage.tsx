          ...
          <div className="bg-white border border-[#E5E7EB] rounded-lg p-8 shadow-sm">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <button
                    ...
                    disabled={isLoading}
                    className="absolute right-3 top-1/2 -translate-y-1/2 text-[#9CA3AF] hover:text-[#6B7280] transition-colors disabled:cursor-not-allowed"
                  >
              ...
              <div className="flex items-center justify-between">
                <label className="flex items-center gap-2 cursor-pointer">
                  <input 
                    type="checkbox" 
                    disabled={isLoading}
                    className="w-4 h-4 rounded border-[#D1D5DB] text-[#1976D2] disabled:cursor-not-allowed" 
                  />
                ...
                <button 
                  type="button" 
                  disabled={isLoading}
                  className="text-sm text-[#1976D2] hover:text-[#1565C0] font-semibold disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  Forgot password?
                </button>
              </div>
              ...
              <button 
                type="submit"
                disabled={isLoading}
                className={`w-full h-11 rounded-lg font-semibold transition-all flex items-center justify-center gap-2 group ${
                  isLoading
                    ? 'bg-gray-300 text-gray-500 cursor-not-allowed'
                    : 'bg-gradient-to-r from-[#1976D2] to-[#1565C0] text-white hover:shadow-lg'
                }`}
              >
                {isLoading ? (
                  <>
